...
class TaskManagerApp(MDApp):
    ...
    def is_valid_email(self, email):
        # Regex para verificar se o e-mail termina com @gmail.com, @hotmail.com, etc.
        pattern = '^[\w\.-]+@(?:gmail|hotmail|outlook|yahoo)\.com$'
...
# Layout KV no próprio arquivo Python
kv = '''
<LoginScreen>:
    BoxLayout:
        orientation: 'vertical'
...
# Carrega o layout KV e executa o app
